...
class MatrixOperation:
    ...
    def input_matrices(self):
        return self._implementation.input_matrices()

    def add_matrices(self, matrix1, matrix2):
        return self._implementation.add_matrices(matrix1, matrix2)

    def calculate_determinant(self, matrix):
        return self._implementation.calculate_determinant(matrix)

# Реализация
class NumpyMatrixImplementation:
    def input_matrices(self):
...
def main_menu():
    implementation = NumpyMatrixImplementation()
    matrix_operation = MatrixOperation(implementation)
    ...
    while True:
        ...
        if choice == '4':
            ...
            matrix1, matrix2 = matrix_operation.input_matrices()
            if matrix1 is None or matrix2 is None:
                print("Ошибка ввода матриц. Попробуйте снова.")
        elif choice == '2':
            if matrix1 is not None and matrix2 is not None:
                result_matrix = matrix_operation.add_matrices(matrix1, matrix2)
                determinant_matrix1 = matrix_operation.calculate_determinant(matrix1)
                determinant_matrix2 = matrix_operation.calculate_determinant(matrix2)
            else:
